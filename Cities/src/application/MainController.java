...
public class MainController {
	...
	private Image []gerb= {new Image("application/0.png"),
			new Image("application/1.png"),	new Image("application/2.png"),	new Image("application/3.png"),	
			new Image("application/4.png"),	new Image("application/5.png"),	new Image("application/6.png"),
			new Image("application/7.png"),	new Image("application/8.png"),	new Image("application/9.png"),	
			new Image("application/10.png"),new Image("application/11.png"), new Image("application/12.png"),
			new Image("application/13.png"), new Image("application/14.png"),new Image("application/15.png"), 
			new Image("application/16.png"),new Image("application/17.png"), new Image("application/18.png"),
			new Image("application/19.png"), new Image("application/20.png"),new Image("application/21.png"), 
			new Image("application/22.png"),new Image("application/23.png"), new Image("application/24.png"),
			new Image("application/25.png")	};
