...
public class PhoneBookController {
	...
	public void initialize() {
		nameCol.setCellValueFactory(new PropertyValueFactory<Phone, String>("name"));
		nameCol.setCellFactory(TextFieldTableCell.forTableColumn());
		nameCol.setOnEditCommit(new EventHandler<CellEditEvent<Phone, String>>() {
			@Override
			public void handle(CellEditEvent<Phone, String> t) {
				...
				if (fpn) {
					((Phone) t.getTableView().getItems().get(t.getTablePosition().getRow())).setName(t.getNewValue());

				}
			}
		});

		phoneCol.setCellValueFactory(new PropertyValueFactory<Phone, String>("phone"));
		phoneCol.setCellFactory(TextFieldTableCell.forTableColumn());
		phoneCol.setOnEditCommit(new EventHandler<CellEditEvent<Phone, String>>() {
			...
			public void handle(CellEditEvent<Phone, String> t) {
				...
				if (fpp) {
					((Phone) t.getTableView().getItems().get(t.getTablePosition().getRow())).setPhone(t.getNewValue());
				}
			}
		}
		...
		addressCol.setCellValueFactory(new PropertyValueFactory<Phone, String>("address"));
		addressCol.setCellFactory(TextFieldTableCell.forTableColumn());
		addressCol.setOnEditCommit(new EventHandler<CellEditEvent<Phone, String>>() {
			@Override
			public void handle(CellEditEvent<Phone, String> t) {
				...
				if (fpa) {
					((Phone) t.getTableView().getItems().get(t.getTablePosition().getRow()))
	...
	@FXML
	TableView<Phone> phoneList;
	@FXML
	TableColumn<Phone, String> nameCol;
	@FXML
	TableColumn<Phone, String> phoneCol;
	@FXML
	TableColumn<Phone, String> addressCol;
	@FXML
	TextField nameInput;
	@FXML
